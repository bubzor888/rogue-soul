...
**Reason**: Omen card definition moved to `lld-omen-cards` as `LLD-OMEN-CARD-011`. Enemy requirements reference that spec.
**Migration**: See `LLD-OMEN-CARD-011` for the full Grave Knit card definition.

---

### Requirement: [LLD-ENEMIES-011] Shared Beast Property — Thick Hide
**Reason**: Omen card definition moved to `lld-omen-cards` as `LLD-OMEN-CARD-012`.
**Migration**: See `LLD-OMEN-CARD-012` for the full Thick Hide card definition.

---

### Requirement: [LLD-ENEMIES-012] Shared Elemental Property — Elemental Synergy
**Reason**: Omen card definition moved to `lld-omen-cards` as `LLD-OMEN-CARD-013`.
**Migration**: See `LLD-OMEN-CARD-013` for the full Elemental Synergy card definition and resistance/vulnerability table.

---

### Requirement: [LLD-ENEMIES-013] Fanatic-Only Omen — Sacred Ground
**Reason**: Omen card definition moved to `lld-omen-cards` as `LLD-OMEN-CARD-014`.
**Migration**: See `LLD-OMEN-CARD-014` for the full Sacred Ground card definition.
...
**Family:** Fanatic. Fanatic omen card: see `LLD-OMEN-CARD-014` (Sacred Ground). Totems: see `LLD-ENEMIES-019`, `LLD-ENEMIES-020`.
