## Purpose
Defines the layout, door symbol taxonomy, and floor-progress indicator for the room select screen presented between encounters, where the player chooses one of two doors.
