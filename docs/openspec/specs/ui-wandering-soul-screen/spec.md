## Purpose
Defines the layout and interaction rules for the Wandering Soul room screen (see `hld-wandering-soul`), where the player may accept 2–3 independently-offered trades.
