...
### Requirement: [HLD-PLATFORM-001] Portrait-First Layout
...
- **THEN** the combat area (rows, enemy/player positions) is visually identical; only the action panel presentation differs

---

### Requirement: [HLD-PLATFORM-002] Abstract Input
...
### Requirement: [HLD-PLATFORM-003] Anchor-Based UI
...
### Requirement: [HLD-PLATFORM-004] Visual-First Events
...
### Requirement: [HLD-PLATFORM-005] Desktop-First Development
