## Purpose
Defines HLD rules for the item system — inventory size constraints, item lifecycle flags (floor-bound, encounter-countdown), and how flagged items are communicated to the player.
## Requirements
